...
import {getNutriValuesPerKg, INutriScorePerKg} from '../../src/utils/getNutriValues';

if (typeof window !== 'undefined') {
    window.getNutriValuesPerKg = getNutriValuesPerKg;
    console.log('getNutriValuesPerKg function attached to window:', window.getNutriValuesPerKg);
}

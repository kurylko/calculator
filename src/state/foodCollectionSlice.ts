...
export const fetchUserFoodItems = createAsyncThunk<IUserFoodItem[], string, { rejectValue: string }>(
    'foodItem/fetchUserFoodItems',
...
export const createFoodItem = createAsyncThunk<IUserFoodItem, { foodInputsValues: IFoodItem }>(
...
const foodCollectionSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchUserFoodItems.fulfilled, (state, action: PayloadAction<IUserFoodItem[]>) => {
                state.isLoading = false;
                state.data = action.payload
            })
            .addCase(fetchUserFoodItems.rejected, (state, action: PayloadAction<string | undefined>) => {
                state.isLoading = false;
            ...
            .addCase(deleteFoodItem.fulfilled, (state, action) => {
                state.isLoading = false
                state.data = state.data.filter(stateFoodItem => stateFoodItem.id !== action.payload)
            })

                        ...
                        <View style={styles.tableContainer}>
                            <View style={styles.table}>
                                <View style={styles.tableRowHead}>
                                    ...
                                    <View style={styles.tableCol}><Text style={styles.tableCell}>Calories
                                        (/kg)</Text></View>
                                    <View style={styles.tableCol}><Text style={styles.tableCell}>Fat,g
                                        (/kg)</Text></View>
                                    <View style={styles.tableCol}><Text style={styles.tableCell}>Carbs,g
                                        (/kg)</Text></View>
                                ...
                                {data.map((item: FoodWithNutriScore) => (
                                    <View style={styles.tableRow} key={item.foodName}>
                                        <View style={styles.tableCol}><Text
                                            style={styles.tableCell}>{item.foodName}</Text></View>
                                        <View style={styles.tableCol}><Text
                                            style={styles.tableCell}>{`${item.calories} (${item?.nutriScorePerKg?.caloriesValuePerKg ?? '-'})`}</Text></View>
                                        <View style={styles.tableCol}><Text
                                            style={styles.tableCell}>{`${item.fat} (${item?.nutriScorePerKg?.fatValuePerKg ?? '-'})`}</Text></View>
                                        <View style={styles.tableCol}><Text
                                            style={styles.tableCell}>{item.protein}</Text></View>
                                        <View style={styles.tableCol}><Text
                                            style={styles.tableCell}>{`${item.carbohydrate} (${item?.nutriScorePerKg?.carbohydrateValuePerKg ?? '-'})`}</Text></View>
                                        <View style={styles.tableCol}><Text
                                            style={styles.tableCell}>{item?.weight}</Text></View>
                                    </View>
                                ))}
                            </View>
                            <Link style={styles.link} src={"https://food-calculator-by-val.netlify.app/"}>Add more
                                healthy food</Link>
                        </View>
                    </View>

                    <View style={styles.bottom}>
                        <Text style={styles.generatedBy}>Generated by <Link style={styles.link}
                                                                            src={"https://food-calculator-by-val.netlify.app/"}>food-calculator-by-val.netlify.app</Link>
                        </Text>
                    </View>
                </View>
            </View>
